        ...
        public static List<ServidorConfig> ObtenerServidores()
        {
            return new List<ServidorConfig>
            {
                new ServidorConfig
                {
                    ...
                    Url = "http://localhost/Eurekabank_Soap_Dotnet/ec.edu.monster.ws/EurekabankWS.svc",
                    IconoColor = "#512BD4",
                ...
                new ServidorConfig
                {
                    ...
                    Url = "http://localhost:5111/api/eureka",
                    IconoColor = "#68217A",
                    Tecnologia = ".NET 8.0"
                },
                new ServidorConfig
                {
                    ...
                    Url = "http://localhost:8080/Eurobank_Restfull_Java/api/eureka",
                    IconoColor = "#F89820",
